...
const seasonPlanningScript=document.createElement('script');seasonPlanningScript.src='season-planning.js';seasonPlanningScript.onload=()=>{const openGamesScript=document.createElement('script');openGamesScript.src='mobile-open-games.js';document.body.appendChild(openGamesScript)};document.body.appendChild(seasonPlanningScript);
