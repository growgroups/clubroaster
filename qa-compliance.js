...
console.log('ClubRoster compliance QA passed: visible compliance centre, Blue Card controls, Queensland Child Safe Standards, safeguarding records, readiness visibility and allocation gating.');
